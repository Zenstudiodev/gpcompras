            ...
            <div class="col-12 col-xl-9">
                <div class="container listado_categorias">
                    ...
                    <?php if ($sub_categorias) { ?>
                        <div class="row">
                            <?php
                            foreach ($sub_categorias->result() as $sub_categoria) {
                                //print_contenido($sub_categoria);
                                ?>
                                <div class="col-12 col-md-4 product_col_categorias">
                                    <div class="card">
                                        <div class="card-body">

                                            <h5 class="card-title"><?php echo  $sub_categoria->producto_sub_categoria;?></h5>
                                            <a href="<?php echo base_url().'productos/listado_productos_categoria/'.$categoria_actual.'/'. $sub_categoria->producto_sub_categoria;?>" class="btn btn-primary">Ver productos</a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
